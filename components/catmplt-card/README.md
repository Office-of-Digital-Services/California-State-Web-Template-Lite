...
The Template Card component is a flexible, highly visual element designed for highlighting content with a combination of images, icons, and structured information. It features a custom-tag wrapper architecture (`<catmplt-card>`) combined with data attributes and tag-based descendant selectors for variants and state management.
...
Applied to the root `<catmplt-card>` element.
