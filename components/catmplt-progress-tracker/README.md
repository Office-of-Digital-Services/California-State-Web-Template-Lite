...
```html
<catmplt-progress-tracker>
  <!-- component markup -->
</catmplt-progress-tracker>
```


The Template Progress Tracker component is a visual timeline designed to show progress through a multi-step process or a chronological list of events. It features a custom-tag wrapper architecture (`<catmplt-progress-tracker>`) combined with data attributes and tag-based descendant selectors for variants.
