...
## Custom Tag Usage
Use this component with its custom wrapper tag:
...
- `<catmplt-form-radio>` - Wrapper class for the fieldset (no default borders/padding)
- `<catmplt-form-radio>` - Wrapper div for each radio-label pair
- `<catmplt-form-radio>` - Styles for the label element

## Structure Notes

**Important:** The `<div>` elements are **not nested in the CSS** and can be used independently:

- **With Fieldset**: Use fieldset + legend for grouped radio buttons (recommended for accessibility)
- **Without Fieldset**: Use just the `<div>` for individual radio buttons
- **Standalone**: The CSS styles apply to `<catmplt-form-radio>` regardless of parent element
...
- `<catmplt-form-radio>` - Wrapper class for the fieldset (no default borders/padding)
- `<catmplt-form-radio>` - Wrapper div for each checkbox-label pair
- `<catmplt-form-radio>` - Styles for the label element
...
- **Without Fieldset**: Use just the `<div>` for individual checkboxes
- **Standalone**: The CSS styles apply to `<catmplt-form-radio>` regardless of parent element
...
<div>
  ...
  <label for="CheckAgree">I agree to the terms</label>
</div>
```
