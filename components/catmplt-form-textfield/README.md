...
```html
<label data-required="true" for="InputName">Full name</label>
<input
  type="text"
...
- `<catmplt-form-textfield>` - Styles for the label element
- `<catmplt-form-textfield>` - Styles for the input element
