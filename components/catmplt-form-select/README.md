...
```html
<label for="InputName">Select an option</label>
<select
...
```html
<label data-required="true" for="InputName">Select an option</label>
<select
...
- `<catmplt-form-select>` - Styles for the label element
- `<catmplt-form-select>` - Styles for the select element
