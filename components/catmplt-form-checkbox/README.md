...
- `<catmplt-form-checkbox>` - Wrapper class for the fieldset (no default borders/padding)
- `<catmplt-form-checkbox>` - Wrapper div for each checkbox-label pair
- `<catmplt-form-checkbox>` - Styles for the label element
...
- **Standalone**: The CSS styles apply to `<catmplt-form-checkbox>` regardless of parent element
