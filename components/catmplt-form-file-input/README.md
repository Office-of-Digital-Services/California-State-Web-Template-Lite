...
```html
<label for="fileInput" data-required="true">
  Upload your file
</label>
<div>
...
- `<catmplt-form-file-input>` - Styles for the label element
- `<catmplt-form-file-input>` - Wrapper div for the file input
