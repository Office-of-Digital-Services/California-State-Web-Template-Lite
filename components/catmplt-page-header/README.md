...
The Template Page Header component provides a clean, responsive header area for landing and content pages. It features a custom-tag wrapper architecture (`<catmplt-page-header>`) combined with data attributes and tag-based descendant selectors for variants.
...
Applied to the root `<catmplt-page-header>` element.
