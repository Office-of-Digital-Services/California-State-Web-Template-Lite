...
<figure data-variant="transparent">
  ...
</figure>

<!-- Dark variant: white text on dark background -->
<figure data-variant="dark">
  ...
</figure>
```
...
```scss
figure<catmplt-executive-profile> { /* Default styling */ }
figure<catmplt-executive-profile>[data-variant="transparent"] { /* No background */ }
figure<catmplt-executive-profile>[data-variant="dark"] { /* Dark background with white text */ }
```
...
figure<catmplt-executive-profile> {
  display: flex;
  flex-direction: row;
  gap: 1rem;
}
...
/* Photo dimensions */
figure<catmplt-executive-profile> > img {
  width: 150px;
  height: 150px;
  object-fit: cover;
}
...
figure<catmplt-executive-profile> > [data-role="executive-profile-body"] {
  flex: 1;
...
- **catmplt-footer**: May contain staff/leadership directory using this profile component
